...
export default function Carte() {
  return (
    <section id="carte" className="bg-vert py-24 md:py-32 relative overflow-hidden">
      {/* Background pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="w-full h-full bg-[repeating-linear-gradient(45deg,#dda228,#dda228_1px,transparent_1px,transparent_30px)]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="font-cinzel text-4xl md:text-5xl text-white font-semibold mb-6">
            La Carte
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {categories.map((cat) => (
            <div
              key={cat.title}
              className="border border-or/20 bg-vert-deep/60 backdrop-blur-sm"
            >
              {/* Category header */}
