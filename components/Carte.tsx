...
const categories: DrinkCategory[] = [
  {
    ...
    icon: "🍺",
    items: [
      { name: "Bock 50 / 66", price: "800 F" },
      { name: "Bock 100", price: "1 000 F" },
      { name: "Beaufort 50", price: "800 F" },
      { name: "Racine 50", price: "800 F" },
      { name: "Castel 50", price: "800 F" },
      { name: "Desperado 33", price: "800 F" },
      { name: "Heineken 33", price: "800 F" },
      { name: "Rhino 33", price: "800 F" },
      { name: "Chill 50", price: "800 F" },
  ...
  },
  {
    ...
    icon: "🍷",
    items: [
      { name: "Vins (tous formats)", price: "10 000 F" },
      { name: "Valpière 100", price: "2 500 F" },
      { name: "Valpière 50", price: "1 200 F" },
      { name: "Tequila 50", price: "800 F" },
    ],
  },
  {
    title: "Sans Alcool",
    ...
    items: [
      ...
      { name: "Rhino / Doppel Énergie", price: "800 F" },
