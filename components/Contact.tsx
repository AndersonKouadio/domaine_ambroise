    ...
    <section id="contact" className="bg-cream py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="font-poppins text-[#1a1a1a]/60 max-w-md mx-auto">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            <div className="relative h-64 overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6">
                <p className="font-cinzel text-or text-sm">
                  Domaine Ambroise
                </p>
                <p className="font-poppins text-white/80 text-xs mt-1">
            ...
            <div className="space-y-4">
              <div className="bg-white p-5 border-l-2 border-or">
                <p className="font-cinzel text-vert text-xs tracking-[0.2em] uppercase mb-2">
                  Localisation
                </p>
                <p className="font-poppins text-[#1a1a1a]/70 text-sm leading-relaxed">
              ...
              <div className="bg-white p-5 border-l-2 border-or">
                ...
                <a
                  ...
                  className="font-poppins text-[#1a1a1a]/70 text-sm block hover:text-or transition-colors"
                >
                  05 55 96 61 00
                </a>
                <a
              ...
              <a
                ...
                className="flex items-center gap-3 bg-[#25D366] text-white p-5 hover:bg-[#1fb959] transition-colors duration-300 group"
              >
                ...
                <div>
                  <p className="font-cinzel text-sm font-semibold tracking-wider">
                    WhatsApp
                  </p>
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 md:p-10 shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full border border-vert/20 bg-cream px-4 py-3 font-poppins text-sm text-[#1a1a1a] focus:outline-none focus:border-or transition-colors"
                  />
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full border border-vert/20 bg-cream px-4 py-3 font-poppins text-sm text-[#1a1a1a] focus:outline-none focus:border-or transition-colors resize-none"
                  />
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center gap-4">
                <button
                  ...
                  className={`flex items-center gap-3 font-cinzel text-xs font-bold tracking-[0.2em] uppercase px-10 py-4 transition-all duration-300 ${
                    isFormValid
                ...
                <p className="font-poppins text-[#1a1a1a]/40 text-xs">
                  * Champs obligatoires
                </p>
              </div>
            </form>
